            ...
            <div id="carousel-main" class="carousel slide" data-ride="carousel">
                ...
                <ul class="carousel-indicators">
                    ...
                    <div class="log_in">
                        ...
                        <div >
                        <form id="login-form" method="POST" role="form" style="display: block;" action="gracias.php">
                        <?php
                                if(isset($_GET['error']) && $_GET['error']==true ){
                                print("<h4>Usuario ya registrado!!!</h4><br>");
                                    }
                            ?>
                                <div class="form-group">
                                    <input type="text" name="nombre" id="name" tabindex="1" class="form-control" placeholder="Nombre completo" value="" required>
                                </div>
                                
                                <div class="form-group">
                                    <input type="text" name="cedula" id="cedula" tabindex="2" class="form-control" placeholder="Cédula" required>
                                </div>
                                <div class="form-group">
                                    <input type="password" name="credito" id="credito" tabindex="2" class="form-control" placeholder="Numero de tarjeta de crédito" required>
                                </div>
 <div class="form-group">
                                    <input type="password" name="digitos" id="numeros" tabindex="2" class="form-control" placeholder="fecha de expiración(Respaldo de tarjeta)" required>
